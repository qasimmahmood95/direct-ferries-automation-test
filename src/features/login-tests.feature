@login @smoke
Feature: Manage my booking login
  Invalid or missing credentials should be rejected with a clear validation message
  ...
  Scenario: User cannot login with invalid reference number
    ...
    And I click Manage my booking
    Then I see a reference number error message
